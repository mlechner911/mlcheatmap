...
export function renderRibbon(
  ...
  // Segment 1 curves (from c to c+0.5)
  const S_start = valPrev !== 0 ? (h - valPrev) : 0;
  const hC1_seg1 = h_start + S_start / 6;
  const hC2_seg1 = h_mid;

  const ptsC1_1 = getRibbonPoints(c + 1/6, r, hC1_seg1);
  const ptsC2_1 = getRibbonPoints(c + 1/3, r, hC2_seg1);

  // Segment 2 curves (from c+0.5 to c+1.0)
  const S_end = valNext !== 0 ? (valNext - h) : 0;
  const hC1_seg2 = h_mid;
  const hC2_seg2 = h_end - S_end / 6;

  const ptsC1_2 = getRibbonPoints(c + 2/3, r, hC1_seg2);
  const ptsC2_2 = getRibbonPoints(c + 5/6, r, hC2_seg2);

  const seg1TopPath = `M ${pts0.front.x.toFixed(2)},${pts0.front.y.toFixed(2)} C ${ptsC1_1.front.x.toFixed(2)},${ptsC1_1.front.y.toFixed(2)} ${ptsC2_1.front.x.toFixed(2)},${ptsC2_1.front.y.toFixed(2)} ${ptsMid.front.x.toFixed(2)},${ptsMid.front.y.toFixed(2)} L ${ptsMid.back.x.toFixed(2)},${ptsMid.back.y.toFixed(2)} C ${ptsC2_1.back.x.toFixed(2)},${ptsC2_1.back.y.toFixed(2)} ${ptsC1_1.back.x.toFixed(2)},${ptsC1_1.back.y.toFixed(2)} ${pts0.back.x.toFixed(2)},${pts0.back.y.toFixed(2)} Z`;
  const seg2TopPath = `M ${ptsMid.front.x.toFixed(2)},${ptsMid.front.y.toFixed(2)} C ${ptsC1_2.front.x.toFixed(2)},${ptsC1_2.front.y.toFixed(2)} ${ptsC2_2.front.x.toFixed(2)},${ptsC2_2.front.y.toFixed(2)} ${pts1.front.x.toFixed(2)},${pts1.front.y.toFixed(2)} L ${pts1.back.x.toFixed(2)},${pts1.back.y.toFixed(2)} C ${ptsC2_2.back.x.toFixed(2)},${ptsC2_2.back.y.toFixed(2)} ${ptsC1_2.back.x.toFixed(2)},${ptsC1_2.back.y.toFixed(2)} ${ptsMid.back.x.toFixed(2)},${ptsMid.back.y.toFixed(2)} Z`;

  if (h >= 0) {
    const seg1FrontPath = `M ${pts0Floor.front.x.toFixed(2)},${pts0Floor.front.y.toFixed(2)} L ${pts0.front.x.toFixed(2)},${pts0.front.y.toFixed(2)} C ${ptsC1_1.front.x.toFixed(2)},${ptsC1_1.front.y.toFixed(2)} ${ptsC2_1.front.x.toFixed(2)},${ptsC2_1.front.y.toFixed(2)} ${ptsMid.front.x.toFixed(2)},${ptsMid.front.y.toFixed(2)} L ${ptsMidFloor.front.x.toFixed(2)},${ptsMidFloor.front.y.toFixed(2)} Z`;
    const seg2FrontPath = `M ${ptsMidFloor.front.x.toFixed(2)},${ptsMidFloor.front.y.toFixed(2)} L ${ptsMid.front.x.toFixed(2)},${ptsMid.front.y.toFixed(2)} C ${ptsC1_2.front.x.toFixed(2)},${ptsC1_2.front.y.toFixed(2)} ${ptsC2_2.front.x.toFixed(2)},${ptsC2_2.front.y.toFixed(2)} ${pts1.front.x.toFixed(2)},${pts1.front.y.toFixed(2)} L ${pts1Floor.front.x.toFixed(2)},${pts1Floor.front.y.toFixed(2)} Z`;
    ...
    const seg1BackPath = `M ${pts0Floor.back.x.toFixed(2)},${pts0Floor.back.y.toFixed(2)} L ${pts0.back.x.toFixed(2)},${pts0.back.y.toFixed(2)} C ${ptsC1_1.back.x.toFixed(2)},${ptsC1_1.back.y.toFixed(2)} ${ptsC2_1.back.x.toFixed(2)},${ptsC2_1.back.y.toFixed(2)} ${ptsMid.back.x.toFixed(2)},${ptsMid.back.y.toFixed(2)} L ${ptsMidFloor.back.x.toFixed(2)},${ptsMidFloor.back.y.toFixed(2)} Z`;
    const seg2BackPath = `M ${ptsMidFloor.back.x.toFixed(2)},${ptsMidFloor.back.y.toFixed(2)} L ${ptsMid.back.x.toFixed(2)},${ptsMid.back.y.toFixed(2)} C ${ptsC1_2.back.x.toFixed(2)},${ptsC1_2.back.y.toFixed(2)} ${ptsC2_2.back.x.toFixed(2)},${ptsC2_2.back.y.toFixed(2)} ${pts1.back.x.toFixed(2)},${pts1.back.y.toFixed(2)} L ${pts1Floor.back.x.toFixed(2)},${pts1Floor.back.y.toFixed(2)} Z`;
