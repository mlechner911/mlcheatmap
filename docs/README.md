...
6.  [Series-Specific Shapes & Group Wrapping](file:///mnt/data2tb/mlcheatmap/docs/series_shapes_and_wrapping.md): Details on row-specific shapes (`shapeFn`) and embedding heatmaps as `<g>` elements (`wrapper: 'g'`) translated to form composite SVG canvases.
